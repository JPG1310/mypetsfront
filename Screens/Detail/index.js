 ...
 return (
  ...
  <Text style={{textAlign: 'center', marginTop: 20, fontSize: 24, fontWeight: "bold"}}>Detalhes</Text>
   ...
   <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
     <View>
       <Text style={styles.text, {fontSize: 24, textAlign: 'center', marginTop: 20, marginBottom: 20,  fontWeight: "bold"}}>Fernandinho</Text>
     </View>
     <View>
       <Text style={styles.text, {fontSize: 18, textAlign: 'center'}}>Independente, tranquilo e dorminhoco. Gato cinza e branco.</Text>
     </View>
